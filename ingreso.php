                        ...
                        <div class="table-responsive-lg">
                            ...
                            <table class="table table-dark table-hover table-bordered text-md-center">
                                ...
                                <tbody class="table-secondary" id="tablaUsuarios">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#AgregarRequerimiento">Agregar <i class="fa-sharp fa-solid fa-code-pull-request"></i></button>
                                        <a href="factores.php">
