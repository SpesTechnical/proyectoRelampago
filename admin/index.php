                            ...
                            <form class="signin-form" id="formLogin">
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control" placeholder="Contraseña" name="passAD" id="passAD">
                                    </div>
                                </div>

                                <div class="form-group text-center">
                                    <button type="button" id="btnloginAdmin" name="btnloginAdmin" class="form-control btn btn-primary">Ingresar <i class="fa-solid fa-right-to-bracket"></i></button>
                                </div>
                                <hr>
